...
> - **Daily narrative briefing**, generated by the active LLM rail (system-side, reusing the `morning_brief` rules) — "what moved / why / what it means". The rail is selectable via `LLM_RAIL` (Anthropic/OpenAI/DeepSeek); currently DeepSeek.
...
- Slow LLM API responses (>30s — show timeout, user can retry)
